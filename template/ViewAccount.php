<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15 px-5">
			<h5 class="m-0">Viewing Account (<?php echo htmlentities($_GET['account_id']) ?>)</h5>
			...
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-md-4 offset-md-4 px-20 py-5 text-center text-md-right">
						<a href="sitebuild.php?username=<?php echo $AccountInfo['account_username']?>" target="_blank" rel="noopener" class="btn btn-secondary btn-block my-5 btn-rounded">Site Builder</a>
